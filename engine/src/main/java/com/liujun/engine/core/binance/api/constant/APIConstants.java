package com.liujun.engine.core.binance.api.constant;
...
public class APIConstants {
    //认证类型（TRADE, MARGIN 和USER_DATA）需要签名
    public static final List<SECURITY_TYPE> NEED_SIGN_TYPE_LIST = Arrays.asList(
            SECURITY_TYPE.TRADE,
