...
import com.liujun.engine.core.binance.api.enums.AlgorithmEnum;
import com.liujun.engine.core.binance.api.enums.CharsetEnum;
...
public class HmacSHA256Base64Utils {
     ...
     * @throws UnsupportedEncodingException
     */
    public static String sign(String str,String secretKey)
            throws CloneNotSupportedException, InvalidKeyException, UnsupportedEncodingException {
        ...
        Mac mac = (Mac) MAC.clone();
        mac.init(secretKeySpec);
        return new String(Hex.encodeHex(mac.doFinal(str.getBytes(CharsetEnum.UTF_8.charset()))));
    }
