package com.liujun.engine.core.okcoinF2;
...
import com.liujun.engine.core.okcoinF.Instrument;
...
@Component
@Scope("prototype")
public class Trade_okcoinF2 extends Trade {
    private static final Logger log = LoggerFactory.getLogger(Trade_okcoinF2.class);
    private static final Logger log_haveTrade = LoggerFactory.getLogger("have_trade");
    public static final String platName = "okcoinF2";
    ...
    @Value("${okcoinF2.alias}")
    private String alias;
    //------------------------


    public Trade_okcoinF2(HttpUtil httpUtil, int platId, double usdRate, Prop prop, Engine engine) throws Exception {
